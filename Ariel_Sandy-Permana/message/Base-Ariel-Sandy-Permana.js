...
const ph = require('../scrape/photooxy.js')
 ...
 const geayubi = fs.readFileSync("./Ariel_Sandy-Permana/scrape/Result/Asupan/geayubi.json");
 const bocil = fs.readFileSync("./Ariel_Sandy-Permana/scrape/Result/Asupan/bocil.json");
 const rikagusriani = fs.readFileSync("./Ariel_Sandy-Permana/scrape/Result/Asupan/rikagusriani.json");
 ...
 const tebakkimia = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/tebakkimia.json');
 const asahotak = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/asahotak.json');
 const susunkata = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/susunkata.json');
 const tebakkalimat = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/tebakkalimat.json');
 const tekateki = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/tekateki.json');
 const caklontong = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/caklontong.json');
 const tebakbendera = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/tebakbendera.json');
 const tebakanime = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/tebakanime.json');
 const tebakkabupaten = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/tebakkabupaten.json');
 const tebaklagu = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/tebaklagu.json');
 const tebaklirik = fs.readFileSync('./Ariel_Sandy-Permana/scrape/Result/Game/tebaklirik.json');
...
if (q.includes('--help')) return reply(examkosong) 
     reply(`*Tunggu Kak ><*`)
const Ariell = fs.readFileSync("./Ariel_Sandy-Permana/scrape/Result/RandomImage/aesthetic.json");
...
if (q.includes('--help')) return reply(examkosong) 
     reply(`*Tunggu Kak ><*`)
const Ariel1 = fs.readFileSync("./Ariel_Sandy-Permana/scrape/Result/RandomVideo/storywa.json");
...
if (q.includes('--help')) return reply(examplyme) 
   ...
   if (m.isQuotedImage) {
    ...
    fs.writeFileSync(`./${ran}`, buffer)
     ...
     .on("end", () => {
      exec(`webpmux -set exif ./Ariel_Sandy-Permana/sticker/data.exif ./${ran} -o ./${ran}`, async (error) => {
      sock.sendMessage(
          from, 
          { 
  ...
  if (m.isQuotedVideo) {
   ...
   var rand2 = '777.webp'
	fs.writeFileSync(`./${rand2}`, buffer)
	 ...
	 .on("error", console.error)
	 .on("end", () => {
	 exec(`webpmux -set exif ./Ariel_Sandy-Permana/sticker/data.exif ./${rand2} -o ./${rand2}`, async (error) => {
	 sock.sendMessage(
	  from, 
	    { 
