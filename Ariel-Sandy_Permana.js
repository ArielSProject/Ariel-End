 ...
 const Options = require('./Ariel_Sandy-Permana/options.js')
 const { info } = Options
 const { color, bgcolor, ConsoleLog, getBuffer } = require('./Ariel_Sandy-Permana/function.js')
 const { state, saveState } = useSingleFileAuthState('./Aespi-MD.json');    
 const { groupResponse } = require('./Ariel_Sandy-Permana/response/group.js')
 const { move } = require('./Ariel_Sandy-Permana/base/mybase')
 ...
 const sock = makeWASocket({ 
   logger: pino({ level: 'silent' }),
        ...
        browser: ['Ariel No Counter', 'Aloha', '5.4'],
        auth: state,
        version
 })
 ...
 store.bind(sock.ev)  
  ...
  sock.ev.on('messages.upsert', async ({ messages }) => {
    ...
    require('./Ariel_Sandy-Permana/message/Base-Ariel-Sandy-Permana.js')(sock, m, store)
